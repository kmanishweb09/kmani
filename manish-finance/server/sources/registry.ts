...
export const SOURCES: SourceDefinition[] = [
  {
    ...
    secCiks: [
      ...
      { cik: "0001108524", name: "Salesforce Inc", companyId: "salesforce" },
      ...
      { cik: "0001065280", name: "Netflix Inc", companyId: "netflix" },
      ...
      { cik: "0001543151", name: "Uber Technologies Inc", companyId: "uber" },
    ],
