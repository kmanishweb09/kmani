...
export const SOURCES: SourceDefinition[] = [
  ...
  {
    id: "pib-press-releases",
    name: "PIB national press releases (RSS), incl. CCI combination approvals",
    publisher: "Press Information Bureau, Government of India",
    kind: "regulator",
    accessMethod: "rss",
    endpoint: "https://www.pib.gov.in/RssMain.aspx?ModId=6&Lang=1&Regid=3",
    documentationUrl: "https://www.pib.gov.in/ViewRss.aspx?reg=1&lang=1",
    capabilities: ["government_press_releases", "competition_approvals"],
    coverage:
      "All-ministry Government of India press releases (English, national). The deal-relevant items are Competition Commission of India combination approvals (“CCI approves …”), which PIB publishes; also financial-sector policy releases. High volume: only items linked to covered companies or deals, or classified as approvals, reach the review queue. Not a substitute for CCI orders or exchange filings.",
    rightsNotes: "Official government press releases. Store titles, dates and links only and link to the original. A CCI approval is not completion.",
    refreshIntervalMinutes: 720,
    staleAfterHours: 72,
    connector: "rss",
    allowedHosts: ["www.pib.gov.in", "pib.gov.in"],
    timeZone: "Asia/Kolkata",
    defaultSectors: [],
    defaultEnabled: false,
    verificationNote:
      "Candidate added in the September 2026 follow-up. The URL pattern is corroborated by search results only; it has never been fetched (build-environment egress policy). Disabled until Sources → Test connection succeeds.",
  },
  {
    id: "uk-cma-cases",
    name: "UK CMA cases and projects (Atom)",
    publisher: "Competition and Markets Authority (GOV.UK)",
    kind: "competition_authority",
    accessMethod: "rss",
    endpoint: "https://www.gov.uk/cma-cases.atom",
    documentationUrl: "https://www.gov.uk/cma-cases",
    capabilities: ["merger_control", "phase_1_decisions", "phase_2_references", "remedies"],
    coverage:
      "UK merger inquiries and other CMA cases as GOV.UK publishes updates: case openings, Phase 1 decisions, Phase 2 references, remedies and final reports. Adds UK merger-control milestones for international deals (e.g. Microsoft–Activision, Broadcom–VMware); it does not cover Indian or other authorities.",
    rightsNotes: "GOV.UK content is published under the Open Government Licence v3.0. Store titles, dates and links; link to the case page.",
    refreshIntervalMinutes: 720,
    staleAfterHours: 96,
    connector: "rss",
    allowedHosts: ["www.gov.uk"],
    timeZone: "Europe/London",
    defaultSectors: [],
    defaultEnabled: false,
    verificationNote:
      "Candidate added in the September 2026 follow-up. GOV.UK finder pages publish Atom feeds; this URL follows that pattern and search results but has never been fetched (build-environment egress policy). Disabled until Sources → Test connection succeeds.",
  },
  {
    id: "cci-combinations",
